<h1>Clear Solution Test Task</h1>
  ...
  <ol>
        <li>
            ...
            <ul>
                <li><strong>Email (required). Add validation against email pattern.</li>
                <li><strong>First name (required)</li>
                <li><strong>Last name (required)</li>
                <li><strong>Birth date (required):</strong> Must be earlier than the current date.</li>
                <li><strong>Address (optional)</li>
                <li><strong>Phone number (optional)</li>
            </ul>
        </li>
        <li>
...
<ul>
    ...
    <li><strong>Endpoint:</strong> /api/v1/user</li>
    <li><strong>Consumes:</strong> JSON (application/json)</li>
    <li><strong>Produces:</strong> JSON (application/json)</li>
    <li><strong>Request Body:</strong> A JSON object representing user details (CreateUserRequest)</li>
    <li><strong>Validation:</strong> Validates the request body against the CreateUserRequest class using @Valid.</li>
...
<ul>
    ...
    <li><strong>Endpoint:</strong> /api/v1/user/{userId}</li>
    <li><strong>Consumes:</strong> JSON (application/json)</li>
    <li><strong>Produces:</strong> JSON (application/json)</li>
    <li><strong>Path Variable:</strong> userId - The ID of the user to update.</li>
    <li><strong>Request Body:</strong> A JSON object representing the fields to update (UpdateUserRequest).</li>
    <li><strong>Validation:</strong> Validates the request body against the UpdateUserRequest class using @Valid.</li>
...
<ul>
    ...
    <li><strong>Produces:</strong> JSON (application/json)</li>
    <li><strong>Path Variable:</strong> userId - The ID of the user to update.</li>
    <li><strong>Request Body:</strong> A JSON object representing all user fields to update (UpdateUserRequest).</li>
    <li><strong>Validation:</strong> Validates the request body against the UpdateUserRequest class using @Valid.</li>
    <li><strong>Response:</strong> Returns a UserResponse representing the updated user.</li>
    <li><strong>HTTP Status:</strong> 200 OK</li>
</ul>
...
<ul>
    ...
    <li><strong>Response:</strong> Returns a UserListResponse with list of users within the specified birth date range.</li>
    <li><strong>HTTP Status:</strong> 200 OK</li>
</ul>
